...
function testAt() {
  describe('MoveAheadKSoList: Test the "at" method', () => {
    ...
    it('should check "at" with k=2 moves element 2 positions ahead', () => {
      const array = [0, 1, 2, 3, 4, 5];
    ...
    it('should check "at" with k=3 moves element 3 positions ahead', () => {
      const array = [0, 1, 2, 3, 4, 5];
