...
function testPush() {
  describe('KInARowSoList: Test the "push" method', () => {
    ...
    it('should check "push" of values [6,5,4] to list [1,2,3] with accessOnly=false after "includes" [3,3]', () => {
      const array = [1, 2, 3];
    ...
    it('should check "push" with k=1 moves on first access', () => {
      const array = [1, 2];
      const inputs = [
