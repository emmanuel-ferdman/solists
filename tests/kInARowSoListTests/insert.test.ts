...
function testInsert() {
  describe('KInARowSoList: Test the "insert" method', () => {
    ...
    it('should check "insert" of values [6,7,8] with indices [0,2,-1] to list [1,2,3,4,5] with accessOnly=false after "includes" [3,3]', () => {
      const array = [1, 2, 3, 4, 5];
    ...
    it('should check "insert" with k=1 moves on first access', () => {
      const array = [1, 2, 3];
      const inputs = [
