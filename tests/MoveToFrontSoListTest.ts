...
const moveToFrontSoListTest = {
  ...
  testFind: function() {
    describe('MoveToFrontSoList: Test the "find" method', function() {
      ...
      it('should check "find" of funcs [v=>v%2==1,v=>v%2==0,v=>v==5] in list [0,1,2,5,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [5,0,1,2,4,5], "expectedValue": 5, "func": (v) => (v == 5)},
        ];
        const ds = new MoveToFrontSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
  ...
  testFindIndex: function() {
    describe('MoveToFrontSoList: Test the "findIndex" method', function() {
      ...
      it('should check "findIndex" of funcs [v=>v==3,v=>v==2,v=>v==4,v=>v==2] in list [0,1,2,3,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [2,3,0,1,4,5], "expectedValue": 0, "func": (v) => (v == 2)},
          {"expectedArray": [4,2,3,0,1,5], "expectedValue": 0, "func": (v) => (v == 4)},
          {"expectedArray": [2,4,3,0,1,5], "expectedValue": 0, "func": (v) => (v == 2)},
        ];
        const ds = new MoveToFrontSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
      ...
      it('should check "findIndex" of funcs [v=>v%2==1,v=>v%2==0,v=>v==5] in list [0,1,2,5,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [0,1,2,5,4,5], "expectedValue": 0, "func": (v) => (v % 2 == 0)},
          {"expectedArray": [5,0,1,2,4,5], "expectedValue": 0, "func": (v) => (v == 5)},
        ];
        const ds = new MoveToFrontSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
  ...
  testFindLastIndex: function() {
    describe('MoveToFrontSoList: Test the "findLastIndex" method', function() {
      ...
      it('should check "findLastIndex" of funcs [v=>v%2==1,v=>v%2==0,v=>v==5] in list [0,1,2,5,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [4,5,0,1,2,5], "expectedValue": 0, "func": (v) => (v % 2 == 0)},
          {"expectedArray": [5,4,5,0,1,2], "expectedValue": 0, "func": (v) => (v == 5)},
        ];
        const ds = new MoveToFrontSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
  ...
  testIndexOf: function() {
    describe('MoveToFrontSoList: Test the "indexOf" method', function() {
      ...
      it('should check "indexOf" of values [3,2,4,2] in list [0,1,2,3,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [2,3,0,1,4,5], "expectedValue": 0, "value": 2},
          {"expectedArray": [4,2,3,0,1,5], "expectedValue": 0, "value": 4},
          {"expectedArray": [2,4,3,0,1,5], "expectedValue": 0, "value": 2},
        ];
        const ds = new MoveToFrontSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
      ...
      it('should check "indexOf" of values [1,0,5] in list [0,1,2,5,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [5,0,1,2,4,5], "expectedValue": 0, "value": 5},
        ];
        const ds = new MoveToFrontSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
  ...
  testLastIndexOf: function() {
    describe('MoveToFrontSoList: Test the "lastIndexOf" method', function() {
      ...
      it('should check "lastIndexOf" of values [1,0,5] in list [0,1,2,5,4,5]', function() {
        ...
        const inputs = [
          {"expectedArray": [1,0,2,5,4,5], "expectedValue": 0, "value": 1},
          {"expectedArray": [0,1,2,5,4,5], "expectedValue": 0, "value": 0},
          {"expectedArray": [5,0,1,2,5,4], "expectedValue": 0, "value": 5},
        ];
        const ds = new MoveToFrontSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
