...
const frequencyCountSoListTest = {
  ...
  testAt: function() {
    describe('FrequencyCountSoList: Test the "at" method', function() {
      ...
      it('should check "at" of indices [4,4,4] in list [0,1,2,3,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [4,3,0,1,2,5], "expectedValue": 3, "index": 4},
          {"expectedArray": [4,3,2,0,1,5], "expectedValue": 2, "index": 4}
        ];
        const ds = new FrequencyCountSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
      ...
      it('should check "at" of indices [0,0,0,4,1,1,1] in list [0,1,2,3,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [0,1,2,3,4,5], "expectedValue": 0, "index": 0},
          {"expectedArray": [0,1,2,3,4,5], "expectedValue": 0, "index": 0},
          {"expectedArray": [0,4,1,2,3,5], "expectedValue": 4, "index": 4},
          {"expectedArray": [0,4,1,2,3,5], "expectedValue": 4, "index": 1},
          {"expectedArray": [0,4,1,2,3,5], "expectedValue": 4, "index": 1},
      ...
      it('should check "at" of indices [-1,-2,-3,3,2,1] in list [0,1,2,3,4,5]', function() {
        ...
        const inputs = [
          {"expectedArray": [5,0,1,2,3,4], "expectedValue": 5, "index": -1},
          {"expectedArray": [5,3,0,1,2,4], "expectedValue": 3, "index": -2},
          {"expectedArray": [5,3,1,0,2,4], "expectedValue": 1, "index": -3},
          {"expectedArray": [5,3,1,0,2,4], "expectedValue": 0, "index": 3},
          {"expectedArray": [1,5,3,0,2,4], "expectedValue": 1, "index": 2},
          {"expectedArray": [1,5,3,0,2,4], "expectedValue": 5, "index": 1}
        ];
        const ds = new FrequencyCountSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
  ...
  testFind: function() {
    describe('FrequencyCountSoList: Test the "find" method', function() {
      ...
      it('should check "find" of funcs [v=>v==3,v=>v==2,v=>v==4,v=>v==2] in list [0,1,2,3,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [3,2,0,1,4,5], "expectedValue": 2, "func": (v) => (v == 2)},
  ...
  testFindIndex: function() {
    describe('FrequencyCountSoList: Test the "findIndex" method', function() {
      ...
      it('should check "findIndex" of funcs [v=>v%2==1,v=>v%2==0,v=>v==5] in list [0,1,2,5,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [1,0,2,5,4,5], "expectedValue": 1, "func": (v) => (v % 2 == 0)},
          {"expectedArray": [1,0,5,2,4,5], "expectedValue": 2, "func": (v) => (v == 5)},
        ];
        const ds = new FrequencyCountSoList(false,array);
        assert.equal(ds.length,array.length);
        assert(ds.isEqual(array));
    ...
    describe('FrequencyCountSoList: Test the "findLast" method', function() {
      ...
      it('should check "findLast" of funcs [v=>v%2==1,v=>v%2==0,v=>v==5] in list [0,1,2,5,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [5,4,0,1,2,5], "expectedValue": 4, "func": (v) => (v % 2 == 0)},
  ...
  testIncludes: function() {
    describe('FrequencyCountSoList: Test the "includes" method', function() {
      ...
      it('should check "includes" of values [3,2,4,2] in list [0,1,2,3,4,5]', function() {
        ...
        const inputs = [
          ...
          {"expectedArray": [3,2,0,1,4,5], "expectedValue": true, "value": 2},
...
export { frequencyCountSoListTest };
